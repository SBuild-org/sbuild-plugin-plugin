...
The SBuild plugin ecosystem just was born. If there are stable plugin for the Scala compiler, packaging, testing, etc, this plugin will start to use these instead of defining all these task on its own.
